...
if(item){if(containerId==='artistAutocomplete'){this.selectedArtist=item}else if(containerId==='albumAutocomplete'){this.selectedAlbum=item;this.selectedDiscogsReleaseId=item.id||null;this.selectedCoverUrl=item.cover_url||null;const yearToUse=item.master_year||item.year;if(yearToUse){const yearInput=document.getElementById('releaseYear');if(yearInput){yearInput.value=yearToUse}}}}}
