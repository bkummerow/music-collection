class MusicCollectionApp{constructor(){this.currentFilter='owned';this.currentSearch='';this.currentStyleFilter='';this.currentFormatFilter='';this.editingAlbum=null;this.autocompleteTimeout=null;this.artistAutocompleteTimeout=null;this.albumAutocompleteTimeout=null;this.isAuthenticated=!1}
...
clearStyleFilter(){this.currentStyleFilter='';this.currentFormatFilter='';const searchInput=document.getElementById('searchInput');if(searchInput){searchInput.value='';searchInput.disabled=!1}
this.loadAlbums()}
clearFormatFilter(){this.currentFormatFilter='';this.currentStyleFilter='';const searchInput=document.getElementById('searchInput');if(searchInput){searchInput.value='';searchInput.disabled=!1}
this.loadAlbums()}
...
updateFilterButtonsWithFilteredCount(filteredAlbums){const hasActiveFilters=this.currentSearch||this.currentStyleFilter||this.currentFormatFilter;if(!hasActiveFilters){return}
...
const albumInput=document.getElementById('albumName');albumInput.disabled=!1;albumInput.placeholder='Enter album name...';this.updateSaveButtonState()}else{title.textContent='Add New Album';this.editingAlbum=null;this.selectedCoverUrl=null;this.selectedDiscogsReleaseId=null;const formatInput=document.getElementById('albumFormat');formatInput.value='';formatInput.readOnly=!0;this.updateAlbumInputState()}
