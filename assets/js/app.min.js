...
async checkAuthStatus(){try{const response=await this.fetchWithCache('api/music_api.php?action=auth_status');const data=await response.json();if(data.success){this.isAuthenticated=data.data.authenticated;this.updateAuthUI()}}catch(error){}}
