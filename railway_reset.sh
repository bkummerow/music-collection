...
# Railway deployment reset script
# This runs after each deployment to ensure demo is in clean state
...
file_put_contents('data/music_collection.json', json_encode(\$demoData, JSON_PRETTY_PRINT));
"
